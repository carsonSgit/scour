...
* `output.format = "text"` is accepted; other formats are rejected until JSON/GitHub output lands.
...
- [ ] Running `scour triage` prints grouped issue triage.
...
- [ ] Triage output groups issues by blocker, fix-now, review, and cleanup.
- [ ] JSON output is valid JSON.
- [ ] JSON output includes severity and triage fields.
- [ ] GitHub output uses valid workflow command syntax.
...
- [ ] rule severity and triage defaults per rule
